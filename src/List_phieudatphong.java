...
public class List_phieudatphong extends Filehandle {
    ...
    public void setup(List_rooms a, List_dichvu b, List_staff c) throws IOException {
        ...
        arrBooked[2] = new Phieudatphong(a, new Customer("Phung Duy C", "0969696969", "123456789", "29", "Au co", "1",
                "Tan Phu", "Tp.HCM", new Time(5, 11, 2020)), "103", b.arrs[4], b.arrs[6], c.arrPerson[3]);
        arrBooked[3] = new Phieudatphong(a, new Customer("Phung Duy A", "0969696969", "123456789", "29", "Au co", "1",
                "Tan Phu", "Tp.HCM", new Time(5, 11, 2020)), "201", b.arrs[4], b.arrs[6], c.arrPerson[3]);
        arrBooked[4] = new Phieudatphong(a, new Customer("Phung Duy K", "0969696969", "123456789", "29", "Au co", "1",
                "Tan Phu", "Tp.HCM", new Time(5, 11, 2020)), "202", b.arrs[4], b.arrs[6], c.arrPerson[3]);
        arrBooked[5] = new Phieudatphong(a, new Customer("Nguyen Van B", "0969696969", "123456789", "29", "Au co", "1",
                "Tan Phu", "Tp.HCM", new Time(5, 11, 2020)), "203", b.arrs[4], b.arrs[6], c.arrPerson[3]);
        arrBooked[6] = new Phieudatphong(a, new Customer("Huynh Lam Khanh Duyen", "0969696969", "123456789", "29",
                "Au co", "1", "Tan Phu", "Tp.HCM", new Time(5, 11, 2020)), "301", b.arrs[4], b.arrs[6], c.arrPerson[3]);
        arrBooked[7] = new Phieudatphong(a, new Customer("Nguyen Van H", "0969696969", "123456789", "29", "Au co", "1",
                "Tan Phu", "Tp.HCM", new Time(5, 11, 2020)), "302", b.arrs[4], b.arrs[6], c.arrPerson[3]);
        arrBooked[8] = new Phieudatphong(a, new Customer("Huynh Lam Khanh D", "0969696969", "123456789", "29", "Au co",
                "1", "Tan Phu", "Tp.HCM", new Time(5, 11, 2020)), "303", b.arrs[4], b.arrs[6], c.arrPerson[3]);
        write();
    }
}